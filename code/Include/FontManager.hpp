...
public:
	...
	std::vector<std::string> SearchFontsInFolder(const std::string& folderPath,
	...
	std::map<std::string, std::string> SearchFontsInFolderAsMap(const std::string& folderPath,
																bool recursive = false) const;
	...
	std::vector<FontInfo> SearchFontsWithInfo(const std::string& folderPath,
											  bool				 recursive = false) const;
	...
	std::map<std::string, FontInfo> SearchFontsWithInfoAsMap(const std::string& folderPath,
															 bool recursive = false) const;
